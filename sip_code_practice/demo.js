...
//SimpleUser delegate
 ...
 var simpleUserDelegate ={
    onCallCreated: function () {
        console.log("[".concat(displayName, "] Call created"));
    ...
    onCallAnswered: function () {
        console.log("[".concat(displayName, "] Call answered"));
        keypadDisabled(false);
        holdCheckboxDisabled(false);
        muteCheckboxDisabled(false);
    },
    onCallHangup: function () {
        console.log("[".concat(displayName, "] Call hangup"));
    ...
    onCallHold: function (held) {
        console.log("[".concat(displayName, "] Call hold ").concat(held));
...
var simpleUser = new SimpleUser(Wss, simpleUserOptions)
...
connectBtn.addEventListener("click", function () {
    ...
    simpleUser
        ...
        console.error("[".concat(simpleUser.id, "] failed to connect"));
        console.error(error);
...
callBtn.addEventListener("click", function () {
    ...
    simpleUser
        ...
        console.error("[".concat(simpleUser.id, "] failed to place call"));
        console.error(error);
...
hangupBtn.addEventListener("click", function () {
    ...
    simpleUser.hangup()["catch"](function (error) {
        console.error("[".concat(simpleUser.id, "] failed to hangup call"));
        console.error(error);
...
disconnectBtn.addEventListener("click", function () {
    ...
    simpleUser
        ...
        console.error("[".concat(simpleUser.id, "] failed to disconnect"));
        console.error(error);
...
holdCheck.addEventListener("change", function () {
    if (holdCheck.checked) {
        ...
        simpleUser.hold()["catch"](function (error) {
            ...
            console.error("[".concat(simpleUser.id, "] failed to hold call"));
            console.error(error);
        ...
        simpleUser.unhold()["catch"](function (error) {
            ...
            console.error("[".concat(simpleUser.id, "] failed to unhold call"));
            console.error(error);
...
muteCheck.addEventListener("change", function () {
    if (muteCheck.checked) {
        ...
        if (simpleUser.isMuted() === false) {
            ...
            console.error("[".concat(simpleUser.id, "] failed to mute call"));
        ...
        if (simpleUser.isMuted() === true) {
            ...
            console.error("[".concat(simpleUser.id, "] failed to unmute call"));
